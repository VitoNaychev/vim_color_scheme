...
" Generated by http://bytefluent.com/vivify 2016-10-12
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Normal guifg=#00ffdd guibg=#3f3f3f guisp=#3f3f3f gui=NONE ctermfg=50 ctermbg=237 cterm=NONE
...
hi Statement guifg=#ff9191 guibg=NONE guisp=NONE gui=NONE ctermfg=210 ctermbg=NONE cterm=NONE
...
hi PreProc guifg=#e5b0ff guibg=NONE guisp=NONE gui=italic ctermfg=183 ctermbg=NONE cterm=NONE
...
hi Type guifg=#f7ff00 guibg=NONE guisp=NONE gui=NONE ctermfg=11 ctermbg=NONE cterm=NONE
...
hi String guifg=#9599cc guibg=NONE guisp=NONE gui=italic ctermfg=146 ctermbg=NONE cterm=NONE
...
hi cursorim guifg=#08060d guibg=#ff4b8d guisp=#ff4b8d gui=NONE ctermfg=232 ctermbg=204 cterm=NONE
hi mbenormal guifg=#609e79 guibg=#3f2b34 guisp=#3f2b34 gui=NONE ctermfg=72 ctermbg=237 cterm=NONE
hi perlspecialstring guifg=#9f6f3f guibg=#3c403d guisp=#3c403d gui=NONE ctermfg=137 ctermbg=238 cterm=NONE
hi doxygenspecial guifg=#56cc69 guibg=NONE guisp=NONE gui=NONE ctermfg=77 ctermbg=NONE cterm=NONE
hi mbechanged guifg=#bd94b7 guibg=#3f2b34 guisp=#3f2b34 gui=NONE ctermfg=139 ctermbg=237 cterm=NONE
hi mbevisiblechanged guifg=#bd94b7 guibg=#8f483a guisp=#8f483a gui=NONE ctermfg=139 ctermbg=95 cterm=NONE
hi doxygenparam guifg=#56cc69 guibg=NONE guisp=NONE gui=NONE ctermfg=77 ctermbg=NONE cterm=NONE
hi doxygensmallspecial guifg=#56cc69 guibg=NONE guisp=NONE gui=NONE ctermfg=77 ctermbg=NONE cterm=NONE
hi doxygenprev guifg=#56cc69 guibg=NONE guisp=NONE gui=NONE ctermfg=77 ctermbg=NONE cterm=NONE
hi perlspecialmatch guifg=#9f6f3f guibg=#3c403d guisp=#3c403d gui=NONE ctermfg=137 ctermbg=238 cterm=NONE
hi cformat guifg=#9f6f3f guibg=#3c403d guisp=#3c403d gui=NONE ctermfg=137 ctermbg=238 cterm=NONE
hi lcursor guifg=#08060d guibg=#4b96ff guisp=#4b96ff gui=NONE ctermfg=232 ctermbg=75 cterm=NONE
hi doxygenspecialmultilinedesc guifg=#6e7c6d guibg=NONE guisp=NONE gui=NONE ctermfg=65 ctermbg=NONE cterm=NONE
hi taglisttagname guifg=#bc4078 guibg=NONE guisp=NONE gui=NONE ctermfg=132 ctermbg=NONE cterm=NONE
hi doxygenbrief guifg=#2ecc48 guibg=NONE guisp=NONE gui=NONE ctermfg=77 ctermbg=NONE cterm=NONE
hi mbevisiblenormal guifg=#869e79 guibg=#8f483a guisp=#8f483a gui=NONE ctermfg=108 ctermbg=95 cterm=NONE
hi user2 guifg=#6e3665 guibg=#5e2b35 guisp=#5e2b35 gui=NONE ctermfg=96 ctermbg=52 cterm=NONE
hi user1 guifg=#b3aecc guibg=#5e2b35 guisp=#5e2b35 gui=NONE ctermfg=146 ctermbg=52 cterm=NONE
hi doxygenspecialonelinedesc guifg=#6e7c6d guibg=NONE guisp=NONE gui=NONE ctermfg=65 ctermbg=NONE cterm=NONE
hi doxygencomment guifg=#7c0067 guibg=NONE guisp=NONE gui=NONE ctermfg=89 ctermbg=NONE cterm=NONE
hi cspecialcharacter guifg=#9f6f3f guibg=#3c403d guisp=#3c403d gui=NONE ctermfg=137 ctermbg=238 cterm=NONE
